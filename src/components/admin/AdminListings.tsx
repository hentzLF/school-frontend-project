...
export function AdminListings() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Listing Management</h1>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              {listings.map((listing) => (
                <tr key={listing.id}>
                  <td className="px-4 py-3 text-gray-900 font-medium">{listing.title}</td>
                  <td className="px-4 py-3 text-gray-600">{listing.providerName}</td>
                  <td className="px-4 py-3 text-gray-600">{listing.categoryName}</td>
                  <td className="px-4 py-3 text-gray-600">{listing.price.toFixed(2)} EUR</td>
