...
describe("payments route", () => {
  ...
  describe("GET", () => {
    it("should return payment data from the backend", async () => {
      const payload = [{ id: "1", bookingId: "booking-1" }];
      ...
      expect(mockBackendFetch).toHaveBeenCalledWith("/api/v1/payments");
    });
    ...
    it("should call the correct backend path without auth override", async () => {
